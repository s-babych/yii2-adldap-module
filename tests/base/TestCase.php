                ...
                'ad' => [
                    ...
                    'providers' => [
                        'default' => [
                            'autoconnect' => true,
                            'config' => [
                                'account_suffix' => '@klipa.lan',
                                'domain_controllers' => ['klipasrv0052.klipa.lan', 'klipasrv0053.klipa.lan'],
                                'base_dn' => 'dc=klipa,dc=lan',
                                'admin_username' => 'svc_apache',
                                'admin_password' => 'Gib5demIndianer!',
                            ]
                        ],
                    ],
                ],
